...
function ProjectComponent({ prop }) {
        ...
        >
            ...
            {isFlipped ? (
                <div className="w-full h-full bg-black bg-opacity-95 absolute cursor-auto p-4 text-sm flex flex-col justify-center flipCard">
                    ...
                    <a href={isFlipped && url} className='rounded-lg bg-indigo-600 bg-opacity-60 p-1 md:hover:bg-opacity-80 cursor-pointer' target='_blank'>Ver Más</a>
